    ...
    <nav className="flex flex-col gap-1 px-2">
      {sections.map((section) => {
        ...
        return (
          ...
          >
            <CollapsibleTrigger className="flex w-full items-center justify-between rounded-md px-3 py-2 text-xs font-semibold tracking-wide text-sidebar-foreground/50 uppercase hover:text-sidebar-foreground/80">
              {title}
