...
export function TestimonyBankToolbar() {
  ...
  return (
    <div className="flex flex-wrap gap-2">
      <div className="relative flex-1 min-w-[200px]">
        ...
        <Input value={search} onChange={(e) => { setSearch(e.target.value); updateParam("q", e.target.value); }} placeholder="Search name or testimony…" className="pl-8" />
      </div>
      <NativeSelect className="w-auto" value={searchParams.get("category") ?? ""} onChange={(e) => updateParam("category", e.target.value)}>
